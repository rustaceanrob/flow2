    ...
    return (
        <div className='flex flex-row justify-center items-center w-full h-screen'>
            <Fades delay={100} style='flex flex-col justify-start items-start space-y-5'>
                ...
                <button className={`flex flex-row justify-start items-start w-full border ${selected === "electrum" ? "border-green-300 bg-green-600 text-white" : "dark:border-zinc-700 border-zinc-300 hover:animate-pulse"} rounded-sm transition-all ease-in-out duration-200`} 
                    onClick={() => setSelected("electrum")}>
                ...
                <button className={`flex flex-row justify-start items-start w-full border ${selected === "rpc" ? "border-green-300 bg-green-600 text-white" : "dark:border-zinc-700 border-zinc-300 hover:animate-pulse"} rounded-sm transition-all ease-in-out duration-200`} 
                    onClick={() => setSelected("rpc")}>
                    <div className='flex flex-col justify-start items-start px-5 py-5 space-y-1'>
